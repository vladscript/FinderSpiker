...
HeadersFeaturesCondition={'Nensembles','Threshold','Dunns','MaxIntraVec','ClassError',...
                     ...
                     'SynWeigthMean','SynWeightMedian','SynWeigthVar','SynWeigthSkew','SynWeigthKurt'};
HeadersFeaturesEnsembles={'NeuronsRation','Time','Dominance','Rate',...
     'ensCAGauc','ensCAGmean','ensCAGmedian','ensCAGvar','ensCAGskew','ensCAGkurt'...
     'IEImean','IEImedian','IEIvar','IEIskew','IEIkurt'...
     'EDmean','EDmedian','EDvar','EDskew','EDkurt'};
