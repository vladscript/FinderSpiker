...
% alphaval             - scalar positive value to increase cloud alphaval (defalut = 1)
...
addOptional(p, 'alphaval', 1, validScalarPosNum)
addOptional(p, 'dot_dodge_amount', 2, @isnumeric)
