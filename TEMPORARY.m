...
%% TOTAL CELLS BOXPLOTS

% figure
% raincloud_plot(TOTAL_AMAN,'color',CM(ColorIndx(2),:),'box_on',1,...
...
% 
% raincloud_plot(TOTAL_CLZ,'color',CM(ColorIndx(3),:),'box_on',1,...
%     'alphaval',5,'box_dodge',1,...
%     'box_dodge_amount',0.8, 'dot_dodge_amount', 0.8,...
%     'box_col_match',0,'box_dodge_amount',.5, 'dot_dodge_amount', 0.5,...
%     'line_width',3,'lwr_bnd',2);
% 
% raincloud_plot(DYSK_A,'color',CM(ColorIndx(1),:),'box_on',1,...
%     'alphaval',5,'box_dodge',1,...
%     'box_dodge_amount',0.8, 'dot_dodge_amount', 0.8,...
%     'box_col_match',0,'box_dodge_amount',.75, 'dot_dodge_amount', 0.75,...
%     'line_width',3,'lwr_bnd',2);
% 
% raincloud_plot(AMAN,'color',CM(ColorIndx(2),:),'box_on',1,...
%     'alphaval',5,'box_dodge',1,...
%     'box_dodge_amount',0.8, 'dot_dodge_amount', 0.8,...
%     'box_col_match',0,'box_dodge_amount',1, 'dot_dodge_amount', 1,...
%     'line_width',3,'lwr_bnd',2);
% 
% raincloud_plot(DYSK_C,'color',CM(ColorIndx(1),:),'box_on',1,...
%     'alphaval',5,'box_dodge',1,...
%     'box_dodge_amount',0.8, 'dot_dodge_amount', 0.8,...
%     'box_col_match',0,'box_dodge_amount',1.25, 'dot_dodge_amount', 1.25,...
%     'line_width',3,'lwr_bnd',2);
% 
% raincloud_plot(CLZ,'color',CM(ColorIndx(3),:),'box_on',1,...
%     'alphaval',5,'box_dodge',1,...
%     'box_dodge_amount',0.8, 'dot_dodge_amount', 0.8,...
%     'box_col_match',0,'box_dodge_amount',1.5, 'dot_dodge_amount', 1.5,...
%     'line_width',3,'lwr_bnd',2);