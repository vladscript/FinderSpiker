...
for c=1:NCplot
    ...
    if NG>0    %% IF THERE'RE ENSEMBLES in the RASTER
        ...
        switch answer
            case 'MIX'
                fNet=Get_Gephi_Network(R,Ncells,XY_selectedClean,Neurons_State_Cluster,OrderOneCondition,ColorState,labels,Experiment,1);
            case 'EVEN'
                fNet=Get_Gephi_Network(R,Ncells,XY_selectedClean,Neurons_State_Cluster,OrderOneCondition,ColorState,labels,Experiment);
            otherwise
